                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="../front_office<?php echo $data['image'] ?>" class="avatar avatar-sm me-3 border-radius-lg" alt="user6">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">
                                <?php 
                                $id=$data['user_id'];
                                $req1 = $bdd->query("SELECT * FROM users where id=$id");
                                while ($data1 = $req1->fetch()) {
                                    echo '<strong>fournisseur:</strong>'.$data1['name'];
                                }
                                ?>
                            </p>
                          </div>
